...
export class DragManager {
    ...
    _applyVisualSwap(monitorId, layout, originalSlot, hoveredSlot, monitorRect, gaps) {
        ...
        // If we were hovering a different monitor previously, revert it first
        if (this._activeDrag.lastHoveredMonitorId && this._activeDrag.lastHoveredMonitorId !== sourceMonId) {
            this._revertVisualSwap(layout, gaps, true);
        }
