...
export class TilingController {
    ...
    handleWindowDragEnd(window) {
        ...
        // Attempt to swap. If no swap occurs, we still schedule a retile to snap it back.
        grid.swapWindowByPointer(wrapper.monitorId, window, monitorRect, gaps);
        this._scheduleRetile(wrapper.workspace, wrapper.monitorId, wrapper.monitorIndex);
    }
