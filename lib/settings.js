...
export class SettingsManager {
    constructor(extension, onSettingsChanged = null) {
        this.settings = extension ? (extension.getSettings ? extension.getSettings('org.gnome.shell.extensions.workflow-tiling') : extension.settings) : null;
        this._changedIds = [];
        ...
        if (this.settings) {
            ...
            this._changedIds.push(this.settings.connect('changed::debug-logging', () => {
                this._load();
            }));
            const kbKeys = [
                'keybindings-mode', 
    ...
    _load() {
        ...
        Logger.DEBUG = this.settings.get_boolean('debug-logging');
    }
