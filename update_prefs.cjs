...
content = content.replaceAll('_leDragEditorDialog(prefWindow, escalator[idx - 1].slots, newSlots => {', '_leDragEditorDialog(prefWindow, escalator[idx - 1].slots, newSlots => {, settings)');
content = content.replaceAll(', settings)', ', settings'); // cleanup 

content = content.replaceAll('_leDragEditorDialog(prefWindow, escalator[escalator.length - 1].slots, newSlots => {', '_leDragEditorDialog(prefWindow, escalator[escalator.length - 1].slots, newSlots => {, settings)');
content = content.replaceAll(', settings)', ', settings'); // cleanup 
