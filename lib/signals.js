...
export class SignalListener {
    ...
    bind() {
        ...
        // Listen for workspace removals
        connect(global.workspace_manager, 'workspace-removed', () => {
            if (this.controller.workspaceManager) {
                this.controller.workspaceManager.pruneLayouts();
            }
        });
